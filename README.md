...
| [**`ui-testing/`**](./ui-testing) | UI Test Automation | Java 17, Selenide, JUnit 5, Page Object Model, Allure | 🟡 В разработке |
...
*В разработке.* Автоматизация тестирования пользовательского интерфейса веб‑приложения **SauceDemo**: Java 17, Selenide, JUnit 5, Page Object Model.
